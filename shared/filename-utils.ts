// Shared filename utilities for both client and server
...
export function sanitizeForFilename(
  ...
  return input.substring(0, maxLength).replace(/[^a-zA-Z0-9]/g, "_");
}
...
// Note: saveMockResponse moved to server-specific file
