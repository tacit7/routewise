import { Star, ArrowRight, MapPin, Clock, Heart, Plus, X, ExternalLink } from "lucide-react";
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <div className="p-6">
              ...
              <h3 className="text-2xl font-bold text-slate-800 mb-3">{poi.name}</h3>
              ...
              <div className="grid md:grid-cols-2 gap-4 mb-6">
                ...
                <div className="flex items-center text-slate-600">
                  ...
                  <span className="font-medium">{poi.rating}</span>
                  <span className="text-slate-500 ml-1">({poi.reviewCount} reviews)</span>
                </div>
                
                {poi.isOpen !== null && (
                  <div className="flex items-center">
                    <Clock className="h-5 w-5 mr-2" />
                    <span className={poi.isOpen ? "text-green-600 font-medium" : "text-red-600 font-medium"}>
                      {poi.isOpen ? "Open now" : "Closed"}
                    </span>
                  </div>
                )}
                ...
                {poi.priceLevel && (
                  <div className="flex items-center text-slate-600">
                    ...
                    <span className="font-medium">{"$".repeat(poi.priceLevel)}</span>
                  </div>
                )}
              </div>
